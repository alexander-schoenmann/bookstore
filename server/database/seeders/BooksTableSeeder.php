...
class BooksTableSeeder extends Seeder
{
    public function run(){
        ...
        $book->save(); //brauacht man, weil image schon id braucht, book wurde davor erst angelegt
        ...
        $authors = Author::all()->pluck('id'); //gibt array von authoren ids aus db zurück
