...
class BookController extends Controller
{
    ...
    public function save(Request $request) : JsonResponse {
        ...
        try {
            ...
            DB::commit(); //erst mit commit wird transaction beendet und ausgeführt
            return response()->json($book, 201);
        }
        catch (\Exception $e) {
            DB::rollBack(); //wenn etwas schief geht, wird rückgängig gemacht
    ...
    //Hilfsfunktion, um (Datums)Daten richtig aufzubereiten
    ...
    public function show(Book $book){
        //$book = Book::find($book); //diese zeile könnte man sich auch sparen
